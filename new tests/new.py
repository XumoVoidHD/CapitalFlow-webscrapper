    ...
    def default(self):
        try:
            with sync_playwright() as p:
                ...
                # Find overall sentiment from 'data-hint' attribute
                ...
                if sentiment_element:
                    ...
                    print(f"Overall sentiment from data-hint: {sentiment_text}")
                    self.signal = sentiment_text
                else:
                    print("Sentiment element not found based on data-hint.")
                    self.signal = "Unknown"

                # Extract call premium from the section using the data-hint
                ...
                # Extract put premium from the section using the data-hint
...
if st.button("Alerts"):
    run_discord_bot("x", "x", st.session_state['signal'], st.session_state['call'], st.session_state['put'])
